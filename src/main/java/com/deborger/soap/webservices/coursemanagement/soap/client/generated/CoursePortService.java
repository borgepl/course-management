 ...
 * 
 */
@WebServiceClient(name = "CoursePortService", targetNamespace = "http://deborger.com/courses", wsdlLocation = "http://localhost:8080/ws/courses.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COURSEPORTSERVICE_QNAME = new QName("http://deborger.com/courses", "CoursePortService");
    ...
    public CoursePort getCoursePortSoap11() {
        return super.getPort(new QName("http://deborger.com/courses", "CoursePortSoap11"), CoursePort.class);
    }
    ...
    public CoursePort getCoursePortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://deborger.com/courses", "CoursePortSoap11"), CoursePort.class, features);
    }
